...
__kernel void kernel_xy(const float inner, const float outer, __global const float *world_state, __global  const uint *packed_properties, __global float *buffer)
{
